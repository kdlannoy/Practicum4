 ...
 * @author jrvdvyve
 */
public class ChatPanel extends javax.swing.JPanel implements ChangeListener {
...
private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
    model.addMessage(new ChatMessage(model.getName(), jTextField1.getText()+"\n"));
    ...
    public static ChatPanel createChat(String name) {
        ...
        final ChatPanel bop = new ChatPanel(model);
        
        ChatController controller = new ChatController(model);

        model.addChangeListener(bop);
